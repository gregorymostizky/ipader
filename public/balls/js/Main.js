...
function createTechnologyBall() {
	...
	text.innerHTML = '<span style="color:' + theme[2] + ';font-size:40px;">PERFECT</span><br/><strong>technology</strong><br /><img width="96px" height="95px" src="technology.png"/>';
	...
	text.style.left = ((250*1.2 - text.clientWidth) / 2) +'px';
...
function createArrowBall() {
	...
	text = document.createElement( 'div' );
	text.onSelectStart = null;
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:24px;">HIT</span><strong> the target</strong><br/><img src="arrow.png"/>';
	text.style.color = theme[1];
	text.style.position = 'absolute';
	text.style.left = '0px';
	text.style.top = '0px';
	...
	text.style.left = ((250*0.8 - text.clientWidth) / 2) +'px';
	text.style.top = ((250*0.5 - text.clientHeight) / 2) +'px';	
...
function createKonteraBall() {
	...
	//text.innerHTML = '<span style="color:' + theme[0] + ';font-size:24px;">HIT</span><strong> the target</strong><br/><img src="logo.png"/>';
	text.innerHTML = '<span style="color:' + theme[2] + '"><strong>'+xxx+'</strong></span><br/><span style="color:' + theme[0] + ';font-size:40px;">'+yyy+'</span><br /><img src="'+zzz+'"/>';
	text.style.color = theme[1];
	text.style.position = 'absolute';
	text.style.left = '0px';
	text.style.top = '0px';
	...
	text.style.left = ((250*0.87 - text.clientWidth) / 2) +'px';
	text.style.top = ((250*0.8 - text.clientHeight) / 2) +'px';	
